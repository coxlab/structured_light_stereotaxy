...
# save changes
newObjFilename = os.path.splitext(objFilename)[0] + '_cropped' + os.path.splitext(objFilename)[1]
newTextureFilename = os.path.splitext(textureFilename)[0] + '_cropped' + os.path.splitext(textureFilename)[1]
