...
# actual deltas of the dominos (from lowest, 'highest z-value', to
# highest, 'lowest z-value')
d1a = [0.97, 0.97]
d2a = [0.94, 1.02]

# z is the value that the actual delta must be multiplied by to get the
# measured delta
z1 = d1 / d1a
z2 = d2 / d2a
...
# calculate prediction errors (e.g. use z1 to predict d2 given d2a,
# subtract actual d2)
pe1 = z2 * d1a - d1
pe2 = z1 * d2a - d2
